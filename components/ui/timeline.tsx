      ...
      <div ref={ref} className="relative max-w-[1400px] mx-auto pb-20">
            ...
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-2 sm:left-3 md:left-3 w-10 rounded-full bg-surface flex items-center justify-center shadow-sm border border-gray-100">
                {item.icon ? (
                  ...
                  <div className="h-4 w-4 rounded-full bg-surface-container border border-gray-200 p-2" />
                )}
              </div>
              <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-medium text-surface-on-variant">
                {item.title}
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary via-surface-on-variant to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
